package edu.uga.cs.shopsync.frontend;
...
public class Constants {
    ...
    public static final String BASKET_ITEMS_DB_KEY = "basketItems";
    ...
    /**
     * This class contains constants for the names of notification types.
     */
    public static class NotificationTypes {

        public static final String FAILED_TO_INVITE_USER = "FailedToInviteUser";
